...
@section('title', 'Chỉnh sửa Thửa đất')
@section('page-title', 'Chỉnh sửa Thửa đất')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-body">
                    <form action="{{ route('thuadat.update', $thuadat) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="ten_thua" 
                                   name="ten_thua" 
                                   value="{{ old('ten_thua', $thuadat->ten_thua) }}" 
                                   required
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   id="dien_tich" 
                                   name="dien_tich" 
                                   value="{{ old('dien_tich', $thuadat->dien_tich) }}" 
                                   required
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('nongho_id') is-invalid @enderror" 
                                ...
                                @foreach($nongHos as $nongho)
                                    <option value="{{ $nongho->id }}" {{ old('nongho_id', $thuadat->nongho_id) == $nongho->id ? 'selected' : '' }}>
                                        {{ $nongho->ten }}
                                    </option>
                                @endforeach
                            </select>
